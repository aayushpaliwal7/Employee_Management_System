...
const Update = () => {
    ...
    useEffect(()=> {
        axios.get(`http://localhost:8080/employee/${index}`)
        .then((response)=> {
    ...
    let Formhandle=()=> {
        let payload = {ename, cname, designation, phone, email, password, address}
    axios.put(`http://localhost:8080/employee/${index}`,payload)
    .then(()=> {
